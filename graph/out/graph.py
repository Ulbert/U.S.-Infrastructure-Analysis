...
original_data = pd.read_csv("../../hive/output/analyze")
normalized_data = pd.read_csv("../../hive/output/analyze_normalized")
normalized_data = normalized_data.fillna(0)
normalized_data = normalized_data.replace('\\N',0)
original_data = original_data.fillna(0)
original_data = original_data.replace('\\N',0)
...
reg_line("Freight Per Sq Mile Normalized vs State and Local Income Tax Normalized",t, 'state_local_income_tax_normalized', 'freight_per_sq_mile_normalized')
...
reg_line("Number of Water Systems per Capita Normalized vs Populartion Served Normalized",t, 'population_served_normalized','water_sys_per_cap_normalized')
...
reg_line("Number of Water Sytems Normalized vs Estate Tax per Sq Mi Normalized",t,'estate_tax_per_sq_normalized','water_systems_normalized')


reg_line("Number of Water Systems per Capita Normalized vs Estate Tax per Sq Mi Normalized",t,'estate_tax_per_sq_normalized','water_sys_per_cap_normalized')
